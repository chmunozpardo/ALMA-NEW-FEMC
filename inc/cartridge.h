...
#define LNA_STAGE_AVAIL_SECT(Po, Sb, St) \
    buildString(LNA_STAGE_BASE(Po, Sb), St, NULL)  // Section containing the LNA STAGE availability info
...
#define SENSOR_SEC_NAME_SIZE \
    20  // Number of character needed to describe the section names for the cartridge temperature sensors
...
#define CARTRIDGE_SUBSYSTEM_RCA_MASK                                                \
    0x00800                                /* Mask to extract the subsystem number: \
...
#define BIAS_MODULES_RCA_MASK                                                \
    0x00400                         /* Mask to extract the submodule number: \
                                       0 -> Polarization                     \
                                       1 -> Polarization */
...
#define LO_TEMP_MODULES_RCA_MASK                                               \
    0x00780                           /* Mask to extract the submodule number: \
                                         0 -> LO                               \
...
#define CARTRIDGE_TEMP_SUBSYSTEM_MODULES_RCA_MASK                                               \
    0x0070                                             /* Mask to extract the submodule number: \
