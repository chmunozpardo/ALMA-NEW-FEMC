...
#define HARDW_CON_ERR \
    (-5)  //!< There was an error while applying a conversion calculation
#define HARDW_ERROR \
...
#define MON_ERROR_ACT \
    (-13)  //!< Monitor message detected a problem and an action was taken
/* Control */
...
#define ERR_CARTRIDGE_TEMP \
    0x05              //!< Error in the Cartridge Temperature Sensor Module
...
#define ERR_POL_SPECIAL_MSGS \
    0x16                  //!< Error in the Polarization Special Messages Module
...
#define ERR_MODULATION_INPUT \
    0x2C                         //!< Error in the EDFA modulation input module
...
#define ERR_INTRLK_TEMP \
    0x3C  //!< Error in the FETIM interlock temperature module
...
#define ERR_FETIM_EXT_TEMP \
    0x3F  //!< Error in the FETIM external temperature module
#define ERR_COMP_HE2_PRESS \
    0x40  //!< Error in the FETIM compressor He2 pressure module
...
#define ERC_AMBSI_EXPIRED \
    0x06  //!< Parallel port: Timed out waiting for AMBSI ready.  CAN disabled
#define ERC_MAINT_MODE \
    0x07  //!< CAN: message blocked because FE is in MAINTENANCE mode
#define ERC_HARDWARE_TIMEOUT \
    0x08  //!< Timeout waiting for hardware to become ready
...
#define ERC_FPGA_NOT_READY \
    0x0E                        //!< Serial mux: critical error - FPGA not ready
#define ERC_0F 0x0F             //!<
...
extern unsigned char
    errorNewest;  //!< A global to keep track of the newest error index
extern unsigned char
    errorOldest;  //!< A global to keep track of the oldest error index
