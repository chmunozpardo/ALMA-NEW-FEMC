...
#define CRYO_ADC_SUPPLY_CURRENT_SCALE \
    1.488645855  // Scale factor for the supply current (includes the vactor 10 scaling for the voltage itself)
#define CRYO_ADC_CRYO_PRESS_OFFSET (-7.75)  // Offset factor for the cryostat pressure
#define CRYO_ADC_CRYO_PRESS_SCALE \
    0.75  // Scale factor for the cryostat pressure (includes the vactor 10 scaling for the voltage itself)
#define CRYO_ADC_VAC_PORT_PRESS_OFFSET (-6.143)  // Offset factor for the vacuum port pressure
#define CRYO_ADC_VAC_PORT_PRESS_SCALE \
    1.286  // Scale factor for the vacuum port pressure (includes the vactor 10 scaling for the voltage itself)
