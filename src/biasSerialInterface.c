...
static float calibrationCurve[CARTRIDGE_TEMP_TBL_SIZE][2] = {
    ...
    {2.700, 1.61928},    {2.800, 1.61687},    {2.900, 1.61445},    {3.000, 1.61200},    {3.100, 1.60951},
    {3.200, 1.60697},    {3.300, 1.60438},    {3.400, 1.60173},    {3.500, 1.59902},    {3.600, 1.59626},
    {3.700, 1.59344},    {3.800, 1.59057},    {3.900, 1.58764},    {4.000, 1.58465},    {4.200, 1.57848},
    {4.400, 1.57202},    {4.600, 1.56533},    {4.800, 1.55845},    {5.000, 1.55145},    {5.200, 1.54436},
    {5.400, 1.53721},    {5.600, 1.53000},    {5.800, 1.52273},    {6.000, 1.51541},    {6.500, 1.49698},
    {7.000, 1.47868},    {7.500, 1.46086},    {8.000, 1.44374},    {8.500, 1.42747},    {9.000, 1.41207},
    {9.500, 1.39751},    {10.000, 1.3837},    {10.500, 1.37065},   {11.000, 1.35820},   {11.500, 1.34632},
    {12.000, 1.33499},   {12.500, 1.32416},   {13.000, 1.31381},   {13.500, 1.30390},   {14.000, 1.29439},
    {14.500, 1.28526},   {15.000, 1.27645},   {15.500, 1.26794},   {16.000, 1.25967},   {16.500, 1.25161},
    {17.000, 1.24372},   {17.500, 1.23596},   {18.000, 1.22830},   {18.500, 1.22070},   {19.000, 1.21311},
    {19.500, 1.20548},   {20.000, 1.197748},  {21.000, 1.181548},  {22.000, 1.162797},  {23.000, 1.140817},
    {24.000, 1.125923},  {25.000, 1.119448},  {26.000, 1.115658},  {27.000, 1.112810},  {28.000, 1.110421},
    {29.000, 1.108261},  {30.000, 1.106244},  {31.000, 1.104324},  {32.000, 1.102476},  {33.000, 1.100681},
    {34.000, 1.098930},  {35.000, 1.097216},  {36.000, 1.095534},  {37.000, 1.093878},  {38.000, 1.092244},
    {39.000, 1.090627},  {40.000, 1.089024},  {42.000, 1.085842},  {44.000, 1.082669},  {46.000, 1.079492},
    {48.000, 1.076303},  {50.000, 1.073099},  {52.000, 1.069881},  {54.000, 1.066650},  {56.000, 1.063403},
    {58.000, 1.060141},  {60.000, 1.056862},  {65.000, 1.048584},  {70.000, 1.040183},  {75.000, 1.031651},
    {77.350, 1.027594},  {80.000, 1.022984},  {85.000, 1.014181},  {90.000, 1.005244},  {95.000, 0.996174},
    {100.000, 0.986974}, {105.000, 0.977650}, {110.000, 0.968209}, {115.000, 0.958657}, {120.000, 0.949000},
    {125.000, 0.939242}, {130.000, 0.929390}, {135.000, 0.919446}, {140.000, 0.909416}, {145.000, 0.899304},
    {150.000, 0.889114}, {155.000, 0.878851}, {160.000, 0.868518}, {165.000, 0.858120}, {170.000, 0.847659},
    {175.000, 0.837138}, {180.000, 0.826560}, {185.000, 0.815928}, {190.000, 0.805242}, {195.000, 0.794505},
    {200.000, 0.783720}, {205.000, 0.772886}, {210.000, 0.762007}, {215.000, 0.751082}, {220.000, 0.740115},
    {225.000, 0.729105}, {230.000, 0.718054}, {235.000, 0.706964}, {240.000, 0.695834}, {245.000, 0.684667},
    {250.000, 0.673462}, {255.000, 0.662223}, {260.000, 0.650949}, {265.000, 0.639641}, {270.000, 0.628302},
    {273.150, 0.621141}, {275.000, 0.616930}, {280.000, 0.605528}, {285.000, 0.594097}, {290.000, 0.582637},
    {295.000, 0.571151}, {300.000, 0.559639}, {305.000, 0.548102}, {310.000, 0.536542}, {315.000, 0.524961},
    {320.000, 0.513361}, {325.000, 0.501744}, {330.000, 0.490106}, {335.000, 0.478442}, {340.000, 0.466760},
    {345.000, 0.455067}, {350.000, 0.443371}, {355.000, 0.431670}, {360.000, 0.419960}, {365.000, 0.408237},
    {370.000, 0.396503}, {375.000, 0.384757}, {380.000, 0.373002}, {385.000, 0.361235}, {390.000, 0.349453},
    {395.000, 0.337654}, {400.000, 0.325839}, {405.000, 0.314008}, {410.000, 0.302161}, {415.000, 0.290298},
    {420.000, 0.278416}, {425.000, 0.266514}, {430.000, 0.254592}, {435.000, 0.242653}, {440.000, 0.230697},
    {445.000, 0.218730}, {450.000, 0.206758}, {455.000, 0.194789}, {460.000, 0.182832}, {465.000, 0.170901},
    {470.000, 0.159010}, {475.000, 0.147191}, {480.000, 0.135480}, {485.000, 0.123915}, {490.000, 0.112553},
    {495.000, 0.101454}, {500.000, 0.090681}};
...
static float temperatureConversion(float voltage) {
    ...
    for (i = 0; (i < CARTRIDGE_TEMP_TBL_SIZE) && (voltage <= calibrationCurve[i][1]); i++)
        ;
    ...
    slope =
        (calibrationCurve[i + 1][0] - calibrationCurve[i][0]) / (calibrationCurve[i + 1][1] - calibrationCurve[i][1]);
...
/* Initiate ADC conversion
    ...
    if (startAsyncTimer(TIMER_BIAS_ADC_RDY, TIMER_BIAS_TO_ADC_RDY, FALSE) == ERROR) {
        return ERROR;
    }
    ...
    } while ((biasRegisters[currentModule].statusReg.bitField.adcReady == BIAS_ADC_BUSY) &&
...
int setSisMixerBias(void) {
    if (frontend.mode != SIMULATION_MODE) {
        ...
        biasRegisters[currentModule].dac2Reg.bitField.inputRegister =
            BIAS_DAC2_REGISTER(BIAS_DAC2_SIS_MIXER_VOLTAGE(currentPolarizationModule));
        /* Setup quick load */
    ...
    if (frontend.mode != SIMULATION_MODE) {
        ...
        switch (biasMode) {
            case SIS_MIXER_BIAS_MODE_OPEN:
                biasRegisters[currentModule].bReg.bitField.sisBiasMode |= BIAS_BREG_SIS_MODE(currentPolarizationModule);
                break;
...
/* 1 - Parallel write BREG */
    ...
    frontend.cartridge[currentModule].polarization[currentBiasModule].sideband[currentPolarizationModule].sis.openLoop =
        (biasMode == SIS_MIXER_BIAS_MODE_OPEN) ? SIS_MIXER_BIAS_MODE_OPEN : SIS_MIXER_BIAS_MODE_CLOSE;
        ...
        switch (current) {
            ...
            case SIS_MAGNET_BIAS_CURRENT:
                frontend.cartridge[currentModule]
                    ...
                    .sideband[currentPolarizationModule]
                    .sisMagnet.current =
                    (BIAS_ADC_SIS_MAG_I_SCALE * biasRegisters[currentModule].adcData) / BIAS_ADC_RANGE;
                break;
            /* The voltage is given by: 50*(adcData/65536) */
            case SIS_MAGNET_BIAS_VOLTAGE:
                frontend.cartridge[currentModule]
                    ...
                    .sideband[currentPolarizationModule]
                    .sisMagnet.voltage =
                    (BIAS_ADC_SIS_MAG_V_SCALE * biasRegisters[currentModule].adcData) / BIAS_ADC_RANGE;
                break;
            default:
                break;
        }
...
/* 1 - Parallel write BREG */
    ...
    /* Since there is no real hardware read back, if no error occured the
       current state is updated to reflect the issued command. */
    frontend.cartridge[currentModule].polarization[currentBiasModule].sideband[currentPolarizationModule].lna.enable =
        ...
        switch (currentLnaStageModule) {
            ...
            case LNA_STAGE_GATE_V:
                frontend.cartridge[currentModule]
                    ...
                    .sideband[currentPolarizationModule]
                    .lna.stage[currentLnaModule]
                    .gateVoltage = (BIAS_ADC_LNA_GATE_V_SCALE * biasRegisters[currentModule].adcData) / BIAS_ADC_RANGE;
                break;
            default:
                break;
        }
...
int setLnaStage(void) {
    ...
    if (frontend.mode != SIMULATION_MODE) {
        ...
        /* Setup for 1 seconds and start the asynchronous timer */
        if (startAsyncTimer(TIMER_BIAS_DAC1_RDY, TIMER_BIAS_TO_DAC1_RDY, FALSE) == ERROR) {
            return ERROR;
        }
...
/* 1 - Parallel write BREG */
    ...
    /* Since there is no real hardware read back, if no error occured the
       current state is updated to reflect the issued command. */
    frontend.cartridge[currentModule].polarization[currentBiasModule].lnaLed.enable =
        (enable == LNA_LED_ENABLE) ? LNA_LED_ENABLE : LNA_LED_DISABLE;
...
int getTemp(unsigned char polarization, unsigned char sensor) {
    ...
    if (frontend.mode != SIMULATION_MODE) {
        ...
        if (temperature == CARTRIDGE_TEMP_CONV_ERR) {
            ...
            frontend.cartridge[currentModule].cartridgeTemp[currentCartridgeTempSubsystemModule].temp = temperature;
        ...
        frontend.cartridge[currentModule].cartridgeTemp[currentCartridgeTempSubsystemModule].temp =
            temperature + frontend.cartridge[currentModule].cartridgeTemp[currentCartridgeTempSubsystemModule].offset;
    } else {
        // SIMULATION_MODE
        switch (sensor) {
            case 0:
