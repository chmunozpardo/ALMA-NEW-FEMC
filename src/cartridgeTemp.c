...
static TEMP_SENSOR temperatureSensor[CARTRIDGE_TEMP_SENSORS_NUMBER][CARTRIDGES_NUMBER] =
    ...
    {{{P0, S0}, {P0, S0}, {P0, S0}, {P0, S0}, {P0, S0}, {P0, S0}, {P0, S0}, {P0, S0}, {P0, S0}, {P0, S0}},  // 4K Stage
     {{P0, S1}, {P0, S1}, {P1, S0}, {P0, S1}, {P0, S1}, {P0, S1}, {P0, S1}, {P0, S1}, {P0, S1}, {P0, S1}},  // 110K
                                                                                                            // Stage
     {{P0, S2}, {P0, S2}, {P0, S2}, {P0, S2}, {P0, S2}, {P0, S2}, {P0, S2}, {P0, S2}, {P0, S2}, {P0, S2}},  // Mixer
                                                                                                            // Pol0
     ...
     {{P1, S2}, {P1, S2}, {P1, S2}, {P1, S2}, {P1, S2}, {P1, S2}, {P1, S2}, {P1, S2}, {P1, S2}, {P1, S2}}};  // Mixer
                                                                                                             // Pol1
...
void cartTempOffsetHandler(int currentModule, int currentCartridgeTempSubsystemModule) {
    ...
    if (CAN_SIZE) {
        ...
        SAVE_LAST_CONTROL_MESSAGE(
            frontend.cartridge[currentModule].cartridgeTemp[currentCartridgeTempSubsystemModule].lastOffset)

        /* Extract the floating data from the CAN message */
        changeEndian(CONV_CHR_ADD, CAN_DATA_ADD);

        /* Save the new value */
        frontend.cartridge[currentModule].cartridgeTemp[currentCartridgeTempSubsystemModule].offset = CONV_FLOAT;
...
void cartTempHandler(int currentModule, int currentCartridgeTempSubsystemModule) {
    ...
    printf("       Sensor %d in Band %d mapped to Polarization %d, Sensor %d\n", currentCartridgeTempSubsystemModule,
           currentModule, temperatureSensor[currentCartridgeTempSubsystemModule][currentModule].polarization,
